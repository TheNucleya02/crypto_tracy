...
const SUGGESTED_PROMPTS = [
  {
    icon: TrendingUp,
    label: "Analyze Bitcoin's trend",
    prompt: "Give me a detailed analysis of BTC right now",
  },
  {
    icon: Wallet,
  ...
  },
  {
    ...
    prompt: "What's the broader market sentiment today?",
  },
  {
    icon: Newspaper,
    label: "Ethereum news",
    prompt: "Tell me about ETH and recent news",
  },
];
    ...
    async (text: string) => {
      ...
      if (!threadId) {
        const created = await createThread.mutateAsync(
          text.slice(0, 40) || "New conversation",
        );
        threadId = created.id;
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="text-sm font-semibold truncate">
                {activeThread?.title || "AI Market Assistant"}
              </div>
          ...
          {messagesLoading && activeThreadId ? (
            ...
            <div className="h-full flex flex-col items-center justify-center px-6 py-8 overflow-y-auto scrollbar-thin">
              ...
              <h2 className="text-xl font-bold tracking-tight text-center">
                Ask me about the crypto market
              </h2>
              <p className="mt-1.5 text-sm text-muted-foreground text-center max-w-md">
                Get AI-powered insights on prices, news, sentiment, and your
                portfolio.
              </p>
        ...
        <div className="border-t border-border p-3 md:p-4">
          <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
            ...
            <p className="mt-2 text-center text-[10px] text-muted-foreground">
              AI-generated insights using live CoinGecko data. Not financial
              advice.
            </p>
          </form>
        </div>
        ...
        {isUser ? (
          ...
          <div
            className={cn(
              ...
              streaming &&
                "after:inline-block after:ml-0.5 after:h-3.5 after:w-0.5 after:bg-foreground after:align-middle after:animate-pulse",
            )}
          >
            {message.content}
          </div>
